"""
Context encoder for conditioning the diffusion model on game situation.
"""
import torch
...
def build_context_vocab(dataset) -> Dict[str, Dict]:
    """
    Build vocabulary mappings for categorical features from dataset.
    
    This would scan the dataset to find all unique values for each categorical feature.
    """
    vocab = {}
